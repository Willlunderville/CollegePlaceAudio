...
required_files=(
  ...
  "assets/vice-hbo.jpg"
  "assets/brands/vice-tv.svg"
  "assets/brands/netflix.svg"
  "assets/brands/boost-mobile.png"
  "assets/brands/hbo.svg"
  "assets/brands/vice.svg"
  "assets/brands/imagicomm.png"
  "assets/brands/showtime.svg"
  "assets/favicon.png"
